	...
	public class WaterBreathingSpellHandler : SpellHandler
	{
		...
		public override void OnEffectStart(GameSpellEffect effect)
		{
			...
			if (player != null)
			{
				...
				player.BaseBuffBonusCategory[eProperty.WaterSpeed] += (int)Spell.Value;
			...
			MessageToLiving(effect.Owner, Spell.Message1 == string.Empty ? LanguageMgr.GetTranslation(player?.Client, "WaterBreathingSpellHandler.Message.Start") : Spell.Message1, toLiving);
		...
		public override int OnEffectExpires(GameSpellEffect effect, bool noMessages)
		{
            ...
            if (player != null)
			{
				...
				if (player.IsDiving & player.CanBreathUnderWater == false)
					MessageToLiving(effect.Owner, LanguageMgr.GetTranslation(player.Client, "WaterBreathingSpellHandler.Message.Expires"), eChatType.CT_SpellExpires);
			}
