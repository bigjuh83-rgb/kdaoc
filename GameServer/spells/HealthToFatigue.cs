...
namespace DOL.GS.Spells
{
	...
	public class HealthToEndurance : SpellHandler
	{
		...
		public override bool CheckBeginCast(GameLiving selectedTarget)
		{
			...
			{
				MessageToCaster(LanguageMgr.GetTranslation((Caster as GamePlayer)?.Client, "HealthToEndurance.EnduranceFull"), eChatType.CT_Spell);
				return false;
			}
		...
		protected virtual void GiveEndurance(GameLiving target, int amount)
		{
			...
			MessageToCaster(LanguageMgr.GetTranslation((Caster as GamePlayer)?.Client, "HealthToEndurance.TransferLifeToEndurance", amount), eChatType.CT_Spell);
		}
