...
namespace DOL.GS.Spells
{
    ...
    public class AlvarusMorph : Morph
    {
        ...
        public override void ApplyEffectOnTarget(GameLiving target)
        {
            ...
            {
                MessageToCaster(LanguageMgr.GetTranslation((Caster as GamePlayer)?.Client, "Artifacts.Alvarus.MustBeUnderwater"), eChatType.CT_SpellResisted);
                return;
            }
            foreach (GameSpellEffect Effect in targetPlayer.EffectList.GetAllOfType<GameSpellEffect>())
            {
                ...
                {
                    targetPlayer.Out.SendMessage(LanguageMgr.GetTranslation(targetPlayer.Client, "Artifacts.ActiveMorph"), DOL.GS.PacketHandler.eChatType.CT_SpellResisted, DOL.GS.PacketHandler.eChatLoc.CL_ChatWindow);
                    return;
                }
            }
