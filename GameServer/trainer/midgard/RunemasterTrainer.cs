	...
	public class RunemasterTrainer : GameTrainer
	{
		...
		public override bool Interact(GamePlayer player)
		{
			...
			else
			{
				...
				{
					player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "MidgardTrainer.JoinHousePrompt", this.Name, "join the House of Odin", "Runemaster"), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
		...
		public override bool WhisperReceive(GameLiving source, string text)
		{
			...
			switch (text) {
				case "join the House of Odin":
					...
					if (CanPromotePlayer(player)) {
						PromotePlayer(player, (int)eCharacterClass.Runemaster, LanguageMgr.GetTranslation(player.Client.Account.Language, "MidgardTrainer.WelcomeArmy", "Runemaster"), null);
