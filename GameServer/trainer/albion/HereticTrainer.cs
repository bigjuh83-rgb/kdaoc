	...
	public class HereticTrainer : GameTrainer
	{
		...
		public override bool Interact(GamePlayer player)
		{
			...
			else
			{
				...
				{
					player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "AlbionTrainer.HereticPrompt", this.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
		...
		public override bool WhisperReceive(GameLiving source, string text)
		{
			...
			switch (text)
			{
				...
				case "아라운 사원 입문":
					...
					if (CanPromotePlayer(player))
					{
						PromotePlayer(player, (int)eCharacterClass.Heretic, LanguageMgr.GetTranslation(player.Client.Account.Language, "AlbionTrainer.HereticWelcome", player.Name), null);
					}
					break;
			}
			return true;
