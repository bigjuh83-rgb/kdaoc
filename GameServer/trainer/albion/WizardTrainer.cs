	...
	public class WizardTrainer : GameTrainer
	{
		...
		public override bool Interact(GamePlayer player)
		{
			...
			else
			{
				...
				{
						player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "AlbionTrainer.WizardPrompt", this.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
		...
		public override bool WhisperReceive(GameLiving source, string text)
		{
			...
			GamePlayer player = source as GamePlayer;
				...
				case "아카데미 입단":
					...
					if (CanPromotePlayer(player)) {
						PromotePlayer(player, (int)eCharacterClass.Wizard, LanguageMgr.GetTranslation(player.Client.Account.Language, "AlbionTrainer.WizardWelcome"), null);
