	...
	public class ScoutTrainer : GameTrainer
	{
		...
		public override bool Interact(GamePlayer player)
		{
			...
			else
			{
				...
				{
						player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "AlbionTrainer.ScoutPrompt", this.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
		...
		public override bool WhisperReceive(GameLiving source, string text)
		{
			...
			switch (text) {
					...
					case "알비온 수호대 입단":
						...
						if (CanPromotePlayer(player)) {
							PromotePlayer(player, (int)eCharacterClass.Scout, LanguageMgr.GetTranslation(player.Client.Account.Language, "AlbionTrainer.ScoutWelcome"), null);
