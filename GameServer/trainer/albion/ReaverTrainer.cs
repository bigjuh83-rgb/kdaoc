	...
	public class ReaverTrainer : GameTrainer
	{
		...
		public override bool Interact(GamePlayer player)
		{
			...
			else
			{
				...
				{
					player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "AlbionTrainer.ReaverPrompt", this.Name), eChatType.CT_System, eChatLoc.CL_PopupWindow);
			...
			switch (text) {
					...
					if (CanPromotePlayer(player))
					{
						...
						//##Melarlian says, "Here is your Whip of the Initiate. Welcome to the Temple of Arawn, Calaoron."
							PromotePlayer(player, (int)eCharacterClass.Reaver, LanguageMgr.GetTranslation(player.Client.Account.Language, "AlbionTrainer.ReaverWelcome", player.Name), null);	// TODO: gifts
					}
					break;
			}
			return true;
