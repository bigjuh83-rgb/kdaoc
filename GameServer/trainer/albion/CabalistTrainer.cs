	...
	public class CabalistTrainer : GameTrainer
	{
		...
		public override bool Interact(GamePlayer player)
		{
			...
			else
			{
				...
				{
						player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "AlbionTrainer.CabalistPrompt", this.Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
		...
		public override bool WhisperReceive(GameLiving source, string text)
		{
			...
			switch (text) {
					...
					case "그림자 길드 입단":
						...
						if (CanPromotePlayer(player)) {
							PromotePlayer(player, (int)eCharacterClass.Cabalist, LanguageMgr.GetTranslation(player.Client.Account.Language, "AlbionTrainer.CabalistWelcome"), null);
