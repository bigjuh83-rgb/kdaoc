...
namespace DOL.GS.RealmAbilities
{
    public class AtlasOF_Vanish : TimedRealmAbility
    {
        ...
        public override void Execute(GameLiving living)
        {
            ...
            ECSGameEffectFactory.Create(new(player, m_duration, 1, CreateSpell(living)), static (in i) => new AtlasOF_VanishECSEffect(i));
        }
        ...
        private SpellHandler CreateSpell(GameLiving owner)
        {
            ...
            tmpSpell.Range = 0;
            tmpSpell.Description = DOL.Language.LanguageMgr.GetTranslation(DOL.Language.LanguageMgr.DefaultLanguage, "RealmAbility.AtlasOF.Vanish.Description");
