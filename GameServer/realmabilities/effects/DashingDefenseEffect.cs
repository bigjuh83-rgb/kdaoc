...
namespace DOL.GS.Effects
{
    ...
    public class DashingDefenseEffect : StaticEffect, IGameEffect
    {
        ...
        public void Start(GamePlayer guardSource, GamePlayer guardTarget, int duration)
        {
            ...
            {
                guardSource.Out.SendMessage(LanguageMgr.GetTranslation(guardSource.Client.Account.Language, "RealmAbility.DashingDefenseEffect.GuardingCloser", guardTarget.GetName(0, false)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                guardTarget.Out.SendMessage(LanguageMgr.GetTranslation(guardTarget.Client.Account.Language, "RealmAbility.DashingDefenseEffect.GuardedCloser", guardSource.GetName(0, true)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
            }
            else
            {
                guardSource.Out.SendMessage(LanguageMgr.GetTranslation(guardSource.Client.Account.Language, "RealmAbility.DashingDefenseEffect.Guarding", guardTarget.GetName(0, false)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                guardTarget.Out.SendMessage(LanguageMgr.GetTranslation(guardTarget.Client.Account.Language, "RealmAbility.DashingDefenseEffect.Guarded", guardSource.GetName(0, true)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
            }
        ...
        public override void Cancel(bool playerCancel)
        {
            ...
            m_guardSource.Out.SendMessage(LanguageMgr.GetTranslation(m_guardSource.Client.Account.Language, "RealmAbility.DashingDefenseEffect.NoLongerGuarding", m_guardTarget.GetName(0, false)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
            m_guardTarget.Out.SendMessage(LanguageMgr.GetTranslation(m_guardTarget.Client.Account.Language, "RealmAbility.DashingDefenseEffect.NoLongerGuarded", m_guardSource.GetName(0, true)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
