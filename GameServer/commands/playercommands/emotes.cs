...
{
	[CmdAttribute("&bang", ePrivLevel.Player, "방패를 두드립니다.", "/bang")]
	[CmdAttribute("&beckon", ePrivLevel.Player, "손짓으로 부릅니다.", "/beckon")]
	[CmdAttribute("&beg", ePrivLevel.Player, "아이템이나 돈을 구걸합니다.", "/beg")]
	[CmdAttribute("&blush", ePrivLevel.Player, "부끄러운 태도를 보입니다.", "/blush")]
	[CmdAttribute("&bow", ePrivLevel.Player, "정중히 인사합니다.", "/bow")]
	[CmdAttribute("&charge", ePrivLevel.Player, "돌격합니다!", "/charge")]
	[CmdAttribute("&cheer", ePrivLevel.Player, "두 손을 들고 환호합니다.", "/cheer")]
	[CmdAttribute("&clap", ePrivLevel.Player, "박수를 칩니다.", "/clap")]
	[CmdAttribute("&cry", ePrivLevel.Player, "서럽게 웁니다.", "/cry")]
	[CmdAttribute("&curtsey", ePrivLevel.Player, "공손히 절합니다.", "/curtsey")]
	[CmdAttribute("&dance", ePrivLevel.Player, "가볍게 춤춥니다.", "/dance")]
	[CmdAttribute("&dismiss", ePrivLevel.Player, "물러가라는 손짓을 합니다.", "/dismiss")]
	[CmdAttribute("&flex", ePrivLevel.Player, "힘을 과시합니다.", "/flex")]
	[CmdAttribute("&hug", ePrivLevel.Player, "포옹하는 동작을 합니다.", "/hug")]
	[CmdAttribute("&induct", ePrivLevel.Player, "의식적인 임명 동작을 합니다.", "/induct")]
	[CmdAttribute("&kiss", ePrivLevel.Player, "손키스를 보냅니다.", "/kiss")]
	[CmdAttribute("&laugh", ePrivLevel.Player, "웃습니다.", "/bang")]
	[CmdAttribute("&military", ePrivLevel.Player, "군례를 합니다.", "/military")]
	[CmdAttribute("&no", ePrivLevel.Player, "고개를 저어 부정합니다.", "/no")]
	[CmdAttribute("&point", ePrivLevel.Player, "앞쪽을 가리킵니다.", "/point")]
	[CmdAttribute("&ponder", ePrivLevel.Player, "생각에 잠긴 듯 행동합니다.", "/ponder")]
	[CmdAttribute("&present", ePrivLevel.Player, "무언가를 바치는 동작을 합니다.", "/present")]
	[CmdAttribute("&raise", ePrivLevel.Player, "손을 들어 주의를 끕니다.", "/raise")]
	[CmdAttribute("&rude", ePrivLevel.Player, "무례한 몸짓을 합니다.", "/rude")]
	[CmdAttribute("&salute", ePrivLevel.Player, "각 잡힌 경례를 합니다.", "/salute")]
	[CmdAttribute("&shrug", ePrivLevel.Player, "어깨를 으쓱합니다.", "/shrug")]
	[CmdAttribute("&slap", ePrivLevel.Player, "누군가를 때리는 동작을 합니다.", "/slap")]
	[CmdAttribute("&slit", ePrivLevel.Player, "적에게 위협적인 제스처를 합니다.", "/slit")]
	[CmdAttribute("&surrender", ePrivLevel.Player, "항복합니다!", "/surrender")]
	[CmdAttribute("&taunt", ePrivLevel.Player, "상대를 도발하는 거친 제스처를 합니다.", "/taunt")]
	[CmdAttribute("&victory", ePrivLevel.Player, "승리의 환호를 합니다.", "/victory")]
	[CmdAttribute("&wave", ePrivLevel.Player, "손을 흔듭니다.", "/wave")]
	[CmdAttribute("&yes", ePrivLevel.Player, "고개를 끄덕입니다.", "/yes")]
	//New
	[CmdAttribute("&sweat", ePrivLevel.Player, "땀을 흘립니다.", "/sweat")]
	[CmdAttribute("&stagger", ePrivLevel.Player, "비틀거립니다.", "/stagger")]
	[CmdAttribute("&yawn", ePrivLevel.Player, "하품합니다.", "/yawn")]
	[CmdAttribute("&doh", ePrivLevel.Player, "아차 하는 동작을 합니다.", "/doh")]
	[CmdAttribute("&confuse", ePrivLevel.Player, "혼란스러워합니다.", "/confuse")]
	[CmdAttribute("&shiver", ePrivLevel.Player, "몸을 떱니다.", "/shiver")]
	[CmdAttribute("&rofl", ePrivLevel.Player, "배를 잡고 웃습니다.", "/rofl")]
	[CmdAttribute("&mememe", ePrivLevel.Player, "자신을 가리킵니다.", "/mememe")]
	[CmdAttribute("&worship", ePrivLevel.Player, "숭배합니다.", "/worship")]
	[CmdAttribute("&drink", ePrivLevel.Player, "마십니다.", "/drink")]
	[CmdAttribute("&angry", ePrivLevel.Player, "화난 표정으로 주변을 봅니다.", "/angry")]
	[CmdAttribute("&lookfar", ePrivLevel.Player, "먼 곳을 바라봅니다.", "/lookfar")]
	[CmdAttribute("&smile", ePrivLevel.Player, "크게 웃습니다.", "/smile")]
	[CmdAttribute("&stench", ePrivLevel.Player, "악취를 손으로 쫓습니다.", "/stench")]
	//New
	[Cmd("&howl", ePrivLevel.Player, "분노에 차 울부짖습니다.", "/howl")]
    [Cmd("&diabolical", ePrivLevel.Player, "사악하게 비웃습니다.", "/diabolical")]
    [Cmd("&brandish", ePrivLevel.Player, "무기를 과시합니다.", "/brandish")]
    [Cmd("&startled", ePrivLevel.Player, "깜짝 놀랍니다.", "/startled")]
    [Cmd("&talk", ePrivLevel.Player, "말하는 동작을 합니다.", "/talk")]
    [Cmd("&monty", ePrivLevel.Player, "카멜롯이 우스운 곳이라고 생각합니다.", "/monty")]
    [Cmd("&loco", ePrivLevel.Player, "정신없다는 듯 행동합니다.", "/loco")]
    [Cmd("&cower", ePrivLevel.Player, "겁에 질려 움츠립니다.", "/cower")]
