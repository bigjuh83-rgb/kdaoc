		...
		public void OnCommand(GameClient client, string[] args)
		{
			...
			if (args.Length > 1)
			{
				...
				if (current != null && current.IsForced(client.Player))
					client.Out.SendMessage(LanguageMgr.GetTranslation(client.Account.Language, "Scripts.Players.SetTitle.Forced"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
				else
				{
