...
namespace DOL.GS.Commands
{
	...
	public class QuestSearchCommandHandler : AbstractCommandHandler, ICommandHandler
	{
		public void OnCommand(GameClient client, string[] args)
		{
			...
			if (searched == false)
			{
				player.Out.SendMessage(LanguageMgr.GetTranslation(client.Account.Language, "Scripts.Players.QuestCommand.CantDoHere"), DOL.GS.PacketHandler.eChatType.CT_Important, DOL.GS.PacketHandler.eChatLoc.CL_SystemWindow);
			}
		}
	}
}
