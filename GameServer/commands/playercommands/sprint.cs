...
namespace DOL.GS.Commands
{
	...
	public class SprintCommandHandler : AbstractCommandHandler, ICommandHandler
	{
		public void OnCommand(GameClient client, string[] args)
		{
			...
			{
				client.Out.SendMessage(LanguageMgr.GetTranslation(client.Account.Language, "Scripts.Players.Sprint.NoAbility"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
			}
		}
	}
}
