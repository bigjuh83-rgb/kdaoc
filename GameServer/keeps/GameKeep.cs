...
namespace DOL.GS.Keeps
{
	...
	public class GameKeep : AbstractGameKeep
	{
		...
		public override bool CheckForClaim(GamePlayer player)
		{
			...
			{
				player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "Keep.NeedPlayersToClaim", ServerProperties.Properties.CLAIM_NUM), eChatType.CT_System, eChatLoc.CL_SystemWindow);
				return false;
			}
