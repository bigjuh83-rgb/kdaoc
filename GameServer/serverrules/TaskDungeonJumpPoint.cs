...
namespace DOL.GS.ServerRules
{
	...
	public class TaskDungeonJumpPoint : IJumpPointHandler
	{
        ...
        public bool IsAllowedToJump(DbZonePoint targetPoint, GamePlayer player)
        {
            ...
            player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "ServerRules.Instance.NeedMission"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return false;
        }
	}
}
