	...
	public class TeleportArea : Area.Circle
	{
		public override void OnPlayerEnter(GamePlayer player)
		{
			...
			if (destination != null)
				...
				player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client, "TeleportArea.DestinationUnavailable", String.Format("{0}:{1}", this.GetType(), this.Description)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
		}
